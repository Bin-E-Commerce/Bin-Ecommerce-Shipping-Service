...
import type { CurrentSellerContext } from '@/modules/shipping/application/types/shipping.types';
import { ShippingService } from '@/modules/shipping/application/services/shipping.service';
import { CancelShipmentDto } from '@/modules/shipping/presentation/dto/cancel-shipment.dto';
...
export class SellerShipmentController {
    ...
    create(
        ...
        return this.shippingService.createForSeller(
            orderId,
    ...
    get(
        ...
        return this.shippingService.getForSeller(
            orderId,
            this.buildContext(headers),
        );
    }
    ...
    refresh(
        ...
        return this.shippingService.refreshForSeller(
            orderId,
            this.buildContext(headers),
        );
    }
    ...
    createReturn(
        ...
        return this.shippingService.createReturnForSeller(
            returnId,
            this.buildContext(headers),
        );
    }
    ...
    advanceDemo(
        ...
        return this.shippingService.advanceDemoForSeller(
            orderId,
            this.buildContext(headers),
        );
    }
    ...
    async label(
        ...
        const shipment = await this.shippingService.getSellerShipmentEntity(
            orderId,
            this.buildContext(headers),
        );
        ...
        response
            ...
            .setHeader(
                'Content-Disposition',
                `attachment; filename="${shipment.trackingCode}.${label.fileExtension}"`,
            )
            .send(label.content);
    }
    ...
    private buildContext(
        ...
        return {
            ...
            permissions: this.header(headers, 'x-user-permissions')
                .split(',')
